...
[Setup]
AppName=Micro-Manager-2.0beta4
AppVerName=Micro-Manager-2.0beta4
AppPublisher=UCSF
...
DefaultDirName=C:/Program Files/Micro-Manager-2.0beta4
DefaultGroupName=Micro-Manager-2.0beta4
...
[Icons]
Name: {group}\Micro-Manager-2.0beta4; Filename: {app}\ImageJ.exe; WorkingDir: {app}
Name: {group}\{cm:UninstallProgram,Micro-Manager-2.0beta4}; Filename: {uninstallexe}
Name: {commondesktop}\Micro-Manager 2.0beta4; Filename: {app}\ImageJ.exe; Tasks: desktopicon; WorkingDir: {app}; IconIndex: 0

[Run]
Filename: "{app}\ImageJ.exe"; WorkingDir: "{app}"; Description: {cm:LaunchProgram,Micro-Manager-2.0beta4}; Flags: nowait postinstall skipifsilent
